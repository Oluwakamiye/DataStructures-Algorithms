...
//
//  Created by Oluwakamiye Akindele on 14/03/2022.
//
...
// MARK: Rotation Algorithms
extension AVLTree {
    // Is used when a series of right children are causing an imbalance
    ...
    // Is used when a series of left children are causing an imbalance
